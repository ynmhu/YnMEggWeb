<?php if ($verified) { header("Location: /adatbazis/"); exit; }
...
if (isset($success)) { 
if ($success) { ?>
<div class="alert alert-success" role="alert"><strong>Success!</strong> You can now access all the features of the adatbazis.</div>
<?php } else {  ?>
...
?>
<form action="/adatbazis/verify" method="post" class="form-horizontal">
